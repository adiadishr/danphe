    ...
    return (
        <Accordion type="multiple" collapsible  className="w-full flex flex-col gap-8">
            <AccordionItem value="item-1">
                <AccordionTrigger className='text28 text-black'>01. Expertise and Reach</AccordionTrigger>
            ...
            <AccordionItem value="item-3">
                <AccordionTrigger className='text28 text-black'>03. Sustainability</AccordionTrigger>
                <AccordionContent className='py-8 text24 tracking-tight text-neutral-500 text-justify text-pretty'>
